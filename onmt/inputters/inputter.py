...
def get_fields(
    ...
    mask_field_kwargs = {"n_feats": n_src_feats,
                         "include_lengths": False,
                         "pad": pad, "bos": None, "eos": None,
                         "truncate": src_truncate,
                         "base_name": "mask"}
    fields["mask"] = fields_getters["vec"](**mask_field_kwargs)

    cross_field_kwargs = {"n_feats": n_src_feats,
                          "include_lengths": False,
                          "pad": pad, "bos": None, "eos": None,
                          "truncate": src_truncate,
                          "base_name": "cross_mask"}
    fields["cross_mask"] = fields_getters["vec"](**cross_field_kwargs)
