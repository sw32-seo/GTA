...
class EnsembleEncoder(EncoderBase):
    ...
    def forward(self, src, lengths=None, adj=None, latent_input=None, segment_input=None):
        enc_hidden, memory_bank, _ = zip(*[
            model_encoder(src, lengths, adj)
...
class EnsembleDecoder(DecoderBase):
    ...
    def forward(self, tgt, memory_bank, memory_lengths=None, step=None, latent_input=None, segment_input=None):
        ...
        dec_outs, attns = zip(*[
            model_decoder(
                tgt, memory_bank[i],
                memory_lengths=memory_lengths, step=step, latent_input=None, segment_input=None)
...
class EnsembleModel(NMTModel):
    ...
    def __init__(self, models, raw_probs=False):
        ...
        self.n_latent = models[0].n_latent
